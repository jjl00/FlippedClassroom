...
public class ImUtil {
    ...
    //设置通用httpclient请求
    public static JSONObject commonHttpRequest(String url,List<NameValuePair> pairs)throws Exception{
    ...
    public static JSONObject jsonHttpRequest(String url, JSONObject jsonObject)throws Exception{
        DefaultHttpClient httpClient = new DefaultHttpClient();
        HttpPost httpPost = new HttpPost(url);
        setCommonHeader(httpPost);
